...
console.log(luisinLutador)

luisinLutador.switchPosition()


guilhermeMatador.atackTarget(luisinLutador)
rafaelMaguinho.atackTarget(luisinLutador)

console.table({luisinLutador,guilhermeMatador,rafaelMaguinho})